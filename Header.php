...
<nav class="custom-navbar">
    <div class="nav-container">
        ...
        <div class="d-flex align-items-center gap-3 position-relative">
            ...
            <div id="user-menu" class="user-menu position-absolute bg-light shadow rounded" style="display: none; right: 0; z-index: 1000;">
                <ul class="list-unstyled m-0 p-2">
                <li><a href="perfil.php" class="dropdown-item">Perfil</a></li>
                <li><a href="login.php" class="dropdown-item">Sair</a></li>
                </ul>
            </div>
            <?php else: ?>
